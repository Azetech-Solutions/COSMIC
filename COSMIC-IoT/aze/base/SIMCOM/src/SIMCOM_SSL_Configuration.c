...
SIMCOM_SSL_Configuration_State_EN SIMCOM_SSL_Config_State = SIMCOM_SSL_Init;
...
void SIMCOM_SSL_CONFIG_MainFunction(void)
{
	...
	{
			SIMCOM_SSL_Configuration_State_EN SIMCOM_SSL_Configuration_State_Before_Execution = SIMCOM_SSL_Config_State;

			BOOL RetryInNextCycle = FALSE;

			switch(SIMCOM_SSL_Config_State)
			{
				case SIMCOM_SSL_Init:
				{
					...
					else
					{
						...
						if(SIMCOM_Job_Result == SIMCOM_Job_Completed)
						{
							...
							if(SIMCOM_IsResponseOK())
							{
								...
								SIMCOM_SSL_Config_State = SIMCOM_SSL_Authentication; // Move to next state
				...
				case SIMCOM_SSL_Authentication:
				{
					// First Ensure the SIMCOM Module is Connected
					if(SIMCOM_Job_Result == SIMCOM_Job_Idle)
					{
					...
					else
					{
						...
						if(SIMCOM_Job_Result == SIMCOM_Job_Completed)
						{
							...
							if(SIMCOM_IsResponseOK())
							{
								SIMCOM_SSL_Config_State = SIMCOM_SSL_CaCert_Configuration; // Move to next state
							}
							else
							{
								// If the returned value is ERROR or something else, then act accordingly
				...
				case SIMCOM_SSL_CaCert_Configuration:
				{
					// First Ensure the SIMCOM Module is Connected
					if(SIMCOM_Job_Result == SIMCOM_Job_Idle)
					{
					...
					else
					{
						...
						if(SIMCOM_Job_Result == SIMCOM_Job_Completed)
						{
							...
							if(SIMCOM_IsResponseOK())
							{
								SIMCOM_SSL_Config_State = SIMCOM_SSL_Clientcert_Configuration; // Move to next state
							}
							else
							{
								// If the returned value is ERROR or something else, then act accordingly
				...
				case SIMCOM_SSL_Clientcert_Configuration:
				{
					// First Ensure the SIMCOM Module is Connected
					if(SIMCOM_Job_Result == SIMCOM_Job_Idle)
					{
					...
					else
					{
						...
						if(SIMCOM_Job_Result == SIMCOM_Job_Completed)
						{
							...
							if(SIMCOM_IsResponseOK())
							{
								SIMCOM_SSL_Config_State = SIMCOM_SSL_Clientkey_Configuration; // Move to next state
							}
							else
							{
								// If the returned value is ERROR or something else, then act accordingly
				...
				case SIMCOM_SSL_Clientkey_Configuration:
				{
					// First Ensure the SIMCOM Module is Connected
					if(SIMCOM_Job_Result == SIMCOM_Job_Idle)
					{
					...
					else
					{
						...
						if(SIMCOM_Job_Result == SIMCOM_Job_Completed)
						{
							...
							if(SIMCOM_IsResponseOK())
							{
								SIMCOM_SSL_Config_State = SIMCOM_SSL_Configured; // Move to next state
							}
							else
							{
								// If the returned value is ERROR or something else, then act accordingly
				...
				break;
				default:
				case SIMCOM_SSL_Configured:
													
				case SIMCOM_SSL_Configration_Error:
				{
			...
			if(SIMCOM_Job_Result == SIMCOM_Job_Aborted)
			{
				...
				SIMCOM_SSL_Config_State = SIMCOM_SSL_Configration_Error;
...
// 						case SIMCOM_SSL_Clientkey_Configuration      : ErrorState = //SIMCOM_Error__SSL_Clientkey_Configuration; break;
			...
			if(SIMCOM_SSL_Configuration_State_Before_Execution != SIMCOM_SSL_Config_State)
			{
