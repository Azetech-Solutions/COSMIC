...
/* Constants for the Tx message TxCommandData on Cloud channel */

#define ComIf_GetIndex_Cloud_TxCommandData()                   (0u)
#define ComIf_GetLength_Cloud_TxCommandData()                  (8u)
#define ComIf_GetShadowBuffer_Cloud_TxCommandData()            ((UBYTE *)ComIf_ShadowBuffer_Cloud_TxCommandData)
#define ComIf_Transmit_Cloud_TxCommandData(x, y)               ComIf_Transmit(C_ComIfChannel_Cloud, 0, ((void *)x), y)
#define ComIf_ForceTransmit_Cloud_TxCommandData(x, y)          do{ComIfTxMsgCfg_Cloud[0].TxFlags.ForceTransmit = TRUE; ComIf_Transmit(C_ComIfChannel_Cloud, 0, ((void *)x), y); } while(0)
#define ComIf_UpdateTxShadowBuffer_Cloud_TxCommandData(x, y)   ComIf_UpdateTxShadowBuffer(C_ComIfChannel_Cloud, 0, ((void *)x), y)
#define ComIf_TransmitFromBuffer_Cloud_TxCommandData()         ComIf_Transmit_Cloud_TxCommandData(ComIf_ShadowBuffer_Cloud_TxCommandData, 8)
#define ComIf_ForceTransmitFromBuffer_Cloud_TxCommandData()    ComIf_ForceTransmit_Cloud_TxCommandData(ComIf_ShadowBuffer_Cloud_TxCommandData, 8)

/* Debug Measurement Variables for TxCommandData on Cloud */

/* [[DEBUG_MEASUREMENT */
/* NAME=ComIfTxMsgCfg_Cloud[0].TxFlags.PendingForTransmission */
/* MODELNAME=ComIfTxMsgCfg_Cloud_TxCommandData_PendingForTransmission */
/* SIZE=1 */
...
/* MODELNAME=ComIfTxMsgCfg_Cloud_TxCommandData_PendingForConfirmation */
/* SIZE=1 */
/* HEADER=ComIf_Config.h */
/* DEBUG_MEASUREMENT]] */
...
/* MODELNAME=ComIfTxMsgCfg_Cloud_TxCommandData_AggregatedInBuffer */
/* SIZE=1 */
/* HEADER=ComIf_Config.h */
/* DEBUG_MEASUREMENT]] */
...
#define P_COMIF_TXBUFFER_SIZE_AVR                    64u

/* Constants for the Tx message AvrTxFunc on Avr channel */

#define ComIf_GetIndex_Avr_AvrTxFunc()                   (0u)
#define ComIf_GetLength_Avr_AvrTxFunc()                  (2u)
#define ComIf_GetShadowBuffer_Avr_AvrTxFunc()            ((UBYTE *)ComIf_ShadowBuffer_Avr_AvrTxFunc)
#define ComIf_Transmit_Avr_AvrTxFunc(x, y)               ComIf_Transmit(C_ComIfChannel_Avr, 0, ((void *)x), y)
#define ComIf_ForceTransmit_Avr_AvrTxFunc(x, y)          do{ComIfTxMsgCfg_Avr[0].TxFlags.ForceTransmit = TRUE; ComIf_Transmit(C_ComIfChannel_Avr, 0, ((void *)x), y); } while(0)
#define ComIf_UpdateTxShadowBuffer_Avr_AvrTxFunc(x, y)   ComIf_UpdateTxShadowBuffer(C_ComIfChannel_Avr, 0, ((void *)x), y)
#define ComIf_TransmitFromBuffer_Avr_AvrTxFunc()         ComIf_Transmit_Avr_AvrTxFunc(ComIf_ShadowBuffer_Avr_AvrTxFunc, 2)
#define ComIf_ForceTransmitFromBuffer_Avr_AvrTxFunc()    ComIf_ForceTransmit_Avr_AvrTxFunc(ComIf_ShadowBuffer_Avr_AvrTxFunc, 2)

/* Debug Measurement Variables for AvrTxFunc on Avr */

/* [[DEBUG_MEASUREMENT */
/* NAME=ComIfTxMsgCfg_Avr[0].TxFlags.PendingForTransmission */
/* MODELNAME=ComIfTxMsgCfg_Avr_AvrTxFunc_PendingForTransmission */
/* SIZE=1 */
/* HEADER=ComIf_Config.h */
/* DEBUG_MEASUREMENT]] */
...
/* MODELNAME=ComIfTxMsgCfg_Avr_AvrTxFunc_PendingForConfirmation */
/* SIZE=1 */
/* HEADER=ComIf_Config.h */
/* DEBUG_MEASUREMENT]] */
...
/* MODELNAME=ComIfTxMsgCfg_Avr_AvrTxFunc_AggregatedInBuffer */
/* SIZE=1 */
/* HEADER=ComIf_Config.h */
/* DEBUG_MEASUREMENT]] */
...
/* Constants for the Rx message AvrStatusData on Avr channel */

#define ComIf_GetIndex_Avr_AvrStatusData()                   (0u)
#define ComIf_GetLength_Avr_AvrStatusData()                  (2u)
#define ComIf_GetBuffer_Avr_AvrStatusData()                  ((UBYTE *)ComIf_RxMessageBuffer_Avr_AvrStatusData)
#define ComIf_GetRxFlags_Avr_AvrStatusData()                 (ComIfRxMsgCfg_Avr[0].RxFlags)
#define ComIf_IsNewMessageReceived_Avr_AvrStatusData()       ((ComIfRxMsgCfg_Avr[0].RxFlags.NewMessageReceived == TRUE) && (ComIfRxMsgCfg_Avr[0].RxFlags.ReceptionStarted == FALSE))
...
extern UBYTE ComIf_ShadowBuffer_Cloud_TxCommandData[];
